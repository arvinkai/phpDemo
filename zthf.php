...
<?php
	...
	<?php
        ...
        ?>
    <li><a
			href="zthf.php?zhuti=<?php echo $zhuti;?>&zhuanqu=<?php echo $_GET['zhuanqu'];?>&page=<?php echo $page-1?>">&laquo;</a>
		</li>
    <?php
    }
    ?>
    ...
    for ($i = 1; $i <= $page_count; ++ $i) {
        if ($page == $i) {
            ?>
			<li class="mui-active"><a
			href="zthf.php?zhuti=<?php echo $zhuti;?>&zhuanqu=<?php echo $_GET['zhuanqu'];?>&page=<?php echo $i;?>"><?php echo $i;?></a>
		</li>						
	<?php
        } else {
            ?>
    ...
    if ($page_count == $page) {
        ?>
   	<li class="mui-disabled"><span> &raquo; </span></li>
	<?php
    } else {
        ?>
    <li><a
			href="zthf.php?zhuti=<?php echo $zhuti;?>&zhuanqu=<?php echo $_GET['zhuanqu'];?>&page=<?php echo $page+1;?>">&raquo;</a>
		</li>
    <?php
    }
    ?>
...
<?php
    ...
    ?>
<table width="776" height="40" border="0" align="center" cellpadding="0"
